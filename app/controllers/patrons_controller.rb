...
class PatronsController < ApplicationController
  def initialize
    super
    @patrons_repo = PatronsRepositoryFactory.create_repository
  end
  ...
  def create()
    ...
    lounge = LoungesRepositoryFactory.create_repository.fetch_by_id(params[:lounge_id])
    ...
    UsersRepositoryFactory.create_repository.check_into_lounge(lounge, current_user)
  ...
  def destroy()
    ...
    UsersRepositoryFactory.create_repository.check_into_lounge(nil, current_user)
